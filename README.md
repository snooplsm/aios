...
outgoing call through connected mute, hold, bounded DTMF, waiting-call,
conference merge/separate, and hang-up controls. Emulator results are explicitly
excluded from physical-device release evidence.
