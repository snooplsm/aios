...
import com.aios.phone.intelligence.PhoneServiceRebindPolicy

/** Restartable, generation-safe binding for Phone's optional context reconciler. */
internal class ResilientCommunicationContextBinding(
    ...
    fun isCurrent(candidate: ICommunicationContext): Boolean =
        started && ready && remote === candidate
